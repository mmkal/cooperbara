...
import static com.google.cooperbara.config.ValidationResult.Level.ERROR;
import static com.google.cooperbara.config.ValidationResult.Level.WARNING;
...
public class ValidationResult {
  ...
  private ValidationResult(List<ValidationMessage> messages) {
    this.messages = ImmutableList.cooperOf(messages);
  }
